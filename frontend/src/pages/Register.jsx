...
const Register = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-dark pt-20 pb-12">
      <div className="max-w-md w-full">
        <div className="card-dark p-8 shadow-2xl">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-bold mb-2">Create Account</h1>
            <p className="text-textSecondary">Join the next generation of gadget lovers</p>
          </div>
          ...
          <form onSubmit={submitHandler} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                />
                <User className="absolute left-4 top-3.5 h-5 w-5 text-textSecondary" />
              </div>
            </div>
